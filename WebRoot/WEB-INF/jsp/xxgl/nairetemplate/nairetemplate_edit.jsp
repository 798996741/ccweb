						...
						<div id="table_report" class="table table-striped table-bordered table-hover new-wkj">
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r">
										<input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="255" placeholder="这里输入模板名称" title="模板名称" />
									</div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one">
								<div class="new-tk-body-one-wk">
									...
									<div class="one-wk-r">
										<select style="width:60%;" name="ISUSE" id="ISUSE">
							...
							<div class="new-tk-body-one new-tx">
								<div class="new-tk-body-one-wk">
									<div class="one-wk-l">开场白:</div>
									<div class="one-wk-r">
										<textarea  id="OPENINGREMARKS" name="OPENINGREMARKS" cols="5">${pd.OPENINGREMARKS}</textarea>
									</div>
								</div>
								<span> </span>
							</div>
							...
							<div class="new-tk-body-one new-tx">
								<div class="new-tk-body-one-wk">
									<div class="one-wk-l">结束语:</div>
									<div class="one-wk-r">
										<textarea id="CONCLUDINGREMARKS" name="CONCLUDINGREMARKS" cols="5">${pd.CONCLUDINGREMARKS}</textarea>
									</div>
								</div>
								<span> </span>
							</div>
...
<script type="text/javascript" charset="utf-8" src="plugins/ueditor/ueditor.all.js"></script>
		...
		function save(){
            ...
            //几个参数需要注意一下
                ...
                url: "nairetemplate/${msg }.do" ,//url
                data: $('#Form_add').serialize(),
                success: function (result) {
                  // alert(result);//打印服务端返回的数据(调试用)
                    if (result.indexOf("success")>=0) {
                    	location.href="<%=basePath%>nairetemplate/list.do";
                    }else{
