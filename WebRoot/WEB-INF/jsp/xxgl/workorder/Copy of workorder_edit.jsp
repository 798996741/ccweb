...
<body class="no-skin">
									...
									<div id="table_report"
										...
										<div class="new-tk-body-one"  style="width:100%">
											<div class="new-tk-body-one-wk" style="float:left">
												...
												<div class="one-wk-r" >
													<a onclick="uploadfile('0');" data-target="#myModal">上传</a>
	...
	<div id="uploadfilediv" style="position:fixed;top:0;left:0;background:rgba(0,0,0,0.7);z-index:2;width:100%;height:100%;display:none;">
		<div id="inneruploadfilediv" style="position:absolute;">
	...
	//alert('${pd.tsbigtype}');
		...
		function uploadfile(){
			  var w = 500px;//计算图片与窗口左边距
              var h = 600px;//计算图片与窗口上边距
              $("#inneruploadfilediv").css({"top":h, "left":w});//设置#innerdiv的top和left属性
              $("#uploadfilediv").fadeIn("fast");//淡入显示#outerdiv及.pimg
		}
