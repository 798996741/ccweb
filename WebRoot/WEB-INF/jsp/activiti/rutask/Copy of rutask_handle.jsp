									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<c:if test="${var.NAME_ != 'RESULT'}">
												<td style="width:120px;text-align: right;padding-top: 10px;">${var.NAME_ == 'USERNAME'?'登录用户':var.NAME_}</td>
									...
									<form action="rutask/handle.do" name="Form_add" id="Form_add" method="post">
										...
										<table id="table_report" class="table table-striped table-bordered table-hover" style="width:100%">
											...
											<c:if test="${taskname=='单部门领导审批'||taskname=='部门领导审批'||taskname=='工单专员审批'}">
												<tr>	
													<td style="width:120px;text-align: right;padding-top: 13px;">是否同意:</td>
													<td colspan="10" >
											...
											<tr>	
												...
												<td style="width:120px;text-align: right;padding-top: 13px;">审批意见:</td>
