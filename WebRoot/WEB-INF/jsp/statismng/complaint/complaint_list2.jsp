...
<script type="text/javascript">
    ...
    window.onload = function () {
        // for (i = 0; i < 2; i++) {
        //     var automain = document.getElementsByClassName('automain')[i]
        //     var autotable = document.getElementsByClassName('autotable')[i]
        //     automain.style.width = (document.documentElement.clientWidth / 7)*5 + 'px'
        //     autotable.style.width = (document.documentElement.clientWidth / 7)*2 + 'px'
        // }
    ...
    function searchmon(mon) {
        ...
        if (mon == '1') {
            //本周
            location.href = "<%=basePath%>/complain/tstypedata.do?starttime=" + getWeekStartDate() +
                "&endtime=" + getWeekEndDate() + "&tsdept=" + tsdepts + "&tstypenamecode=" + tstypenamecode;
        } else if (mon == '2') {
            //本月
            location.href = "<%=basePath%>/complain/tstypedata.do?starttime=" + getMonthStartDate() +
                "&endtime=" + getMonthEndDate() + "&tsdept=" + tsdepts + "&tstypenamecode=" + tstypenamecode;
        } else if (mon == '3') {
            //本季
            location.href = "<%=basePath%>/complain/tstypedata.do?starttime=" + getQuarterStartDate() +
                "&endtime=" + getQuarterEndDate() + "&tsdept=" + tsdepts + "&tstypenamecode=" + tstypenamecode;
        } else if (mon == '4') {
            //本年
            location.href = "<%=basePath%>/complain/tstypedata.do?starttime=" + getYearStartDate() +
