...
public class TemplateService implements TemplateManager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("TemplateMapper.datalist", page);
	}
	...
	public PageData findByCode(PageData pd)throws Exception{
		return (PageData)dao.findForObject("TemplateMapper.findByCode", pd);
	}
	...
	public PageData findByAddr(PageData pd)throws Exception{
		return (PageData)dao.findForObject("TemplateMapper.findByAddr", pd);
	}
