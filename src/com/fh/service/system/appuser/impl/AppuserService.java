...
public class AppuserService implements AppuserManager{
	...
	public void addOperation(PageData pd)throws Exception{
		dao.save("AppuserMapper.addOperation", pd);
	}
	
	public void modOperation(PageData pd)throws Exception{
		dao.save("AppuserMapper.modOperation", pd);
	}

	public void delOperation(PageData pd)throws Exception{
		dao.save("AppuserMapper.delOperation", pd);
	}
	
	
	public PageData findOperationByid(PageData pd)throws Exception{
		return (PageData)dao.findForObject("AppuserMapper.findOperationByid", pd);
	}
	

	@SuppressWarnings("unchecked")
	public List<PageData> listOperation(Page page)throws Exception{
		return (List<PageData>) dao.findForList("AppuserMapper.listOperationlistPage", page);
	}
	
	public List<PageData> proPage(PageData pd)throws Exception{
		return (List<PageData>) dao.findForList("AppuserMapper.proPage", pd);
	}
}
