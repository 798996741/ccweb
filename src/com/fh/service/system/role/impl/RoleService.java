...
public class RoleService implements RoleManager{
	...
	public boolean isRole(String ROLE_ID) throws Exception {
		...
		if(role!=null&&role.getString("ROLE_NAME")!=null&&(role.getString("ROLE_NAME").equals("工单专员")||role.getString("ROLE_NAME").equals("部门领导")||role.getString("ROLE_NAME").equals("部门处理人员")||role.getString("ROLE_NAME").equals("回复人员")||role.getString("ROLE_NAME").equals("工单审批专员"))||role.getString("ROLE_NAME").equals("工单专员")||role.getString("ROLE_NAME").equals("科室处理人员")){
			boo=true;
		}
		return boo;
	}
