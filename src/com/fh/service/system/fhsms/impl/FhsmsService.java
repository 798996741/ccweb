...
public class FhsmsService implements FhsmsManager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("FhsmsMapper.datalist", page);
	}
	...
	public List<PageData> findlistByCondition(Page page) throws Exception {
		return (List<PageData>)dao.findForList("FhsmsMapper.findlistByCondition", page);
	}

	public void tempDelete(PageData pd) throws Exception {
		dao.delete("FhsmsMapper.tempDelete", pd);
	}

	public void tempDeleteAll(String[] ids) throws Exception {
		dao.delete("FhsmsMapper.tempDeleteAll", ids);
	}

	public void editDraft(PageData pd) throws Exception {
		dao.update("FhsmsMapper.editDraft", pd);
	}
}
