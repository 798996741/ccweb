...
public class UserService implements UserManager{
	...
	@Override
	public List<PageData> findwxuser(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.findwxuser", pd);
	}

	@Override
	public List<PageData> finddiswxuser(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("UserMapper.finddiswxuser", pd);
	}

	@Override
	public void insertwxuser(PageData pd) throws Exception {
		dao.save("UserMapper.insertwxuser", pd);
	}

	@Override
	public void updatewxuser(PageData pd) throws Exception {
		dao.update("UserMapper.updatewxuser", pd);
	}
