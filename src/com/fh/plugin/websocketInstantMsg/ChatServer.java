...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqqhuangjianling")){
			this.userjoin(message.replaceFirst("FHadminqqhuangjianling", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqqhuangjianling")){
			this.userLeave(conn);
