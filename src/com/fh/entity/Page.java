...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			sb.append("	<ul class=\"pagination pull-right no-margin\" style=\"padding-top:10px\">\n");
			if(currentPage==1){
				sb.append("	<li><span style=\"width:110px;min-width:110px;border:0px\">共<font color=red>"+totalResult+"</font>条</span></li>\n");
				sb.append("	<li style=\"line-height:20px\"><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"margin-top:5px;width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
				sb.append("	<li><a>首页</a></li>\n");
				sb.append("	<li><a>上页</a></li>\n");
			}else{
				sb.append("	<li><span  style=\"width:110px;min-width:110px;border:0px\">共<font color=red>"+totalResult+"</font>条</span></li>\n");
				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"margin-top:5px;width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
			...
			sb.append("	<li ><span style=\"width:80px;min-width:80px;border:0px\">共"+totalPage+"页</span></li>\n");
			sb.append("	<li><select title='显示条数' style=\"height:30px;width:55px;float:left;margin-top:1px;\" onchange=\"changeCount(this.value)\">\n");
