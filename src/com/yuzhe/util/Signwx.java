...
public class Signwx {
	public static String APP_ID="wxe67d411002fd70ed";
	public static String APPSECRET="e7e3f4e165ff380901f9905c8c443c92";
	
    public static void main(String[] args) {
    	Signwx signwx=new Signwx();
    	
    	System.out.println(getTicket(getAccess_token(APP_ID, APPSECRET)));
